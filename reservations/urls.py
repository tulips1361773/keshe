...
urlpatterns = [
    ...
    path('bookings/<int:booking_id>/reject/', views.reject_booking, name='booking-reject'),
    path('bookings/<int:booking_id>/complete/', views.complete_booking, name='booking-complete'),
